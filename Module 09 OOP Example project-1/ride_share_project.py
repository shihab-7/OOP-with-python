...
class Ride_Request:
    def __init__(self, rider, end_loction) -> None:
        self.rider = rider
        self.end_location = end_loction
...
sakib = Rider('sakib khan', 'sakibkhan@gmail.com', 1243, 'mohakhali', 1200)
niye_jao.add_rider(sakib)
kala_pakhi = Driver('kala pakhi', 'kala@pakhi.com', 5648, 'gulshan 1' )
